...
### 9.1 Why SQL Databases Struggle to Scale
...
### 9.2 Detailed Example: Scaling a Relational Database for a Large E-commerce Website
...
### 9.3 How Key-Value Databases Excel at Scaling
...
### 9.4 Detailed Example: Using DynamoDB for the Same E-commerce Application
